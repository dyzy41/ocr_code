...
from model_resnet_3 import CNN, EncoderRNN, LuongAttnDecoderRNN, model

parser = argparse.ArgumentParser()
parser.add_argument('--trainroot', default='../ocr_data/data_cvt_gray/train', help='path to dataset')
parser.add_argument('--valroot', default='../ocr_data/data_cvt_gray/val', help='path to dataset')
...
def load_modelpth(model):
    ...
    if find_new_file(model_dir) is not None:
        ...
        state_dict = torch.load('./expr/model/model_Rec_done_888.pth')
