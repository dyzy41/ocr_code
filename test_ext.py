...
parser.add_argument('--trainroot', default='/home/weikai/Documents/ocr_data/data_cvt_gray/train', help='path to dataset')
parser.add_argument('--valroot', default='/home/weikai/Documents/ocr_data/data_cvt_gray/val', help='path to dataset')
...
if os.listdir('./expr/model') is not None:
