...
parser.add_argument('--trainroot', default='/home/kawhi/Documents/ocr_data/data/train', help='path to dataset')
parser.add_argument('--valroot', default='/home/wangxiang/Documents/ocr_data/data/val', help='path to dataset')
