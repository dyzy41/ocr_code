...
parser.add_argument('--trainroot', default='../ocr_data/data_cvt_gray_concat/train', help='path to dataset')
parser.add_argument('--valroot', default='../ocr_data/data_cvt_gray_concat/val', help='path to dataset')
